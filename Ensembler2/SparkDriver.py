...
class SparkDriver(object):
    ...
    def refine_implicit(self):
        ...
        def implicit_refine(x):
            result = refinement.refine_implicitMD(x, openmm_platform='CUDA', niterations=5, nsteps_per_iteration=1)
            return result
    ...
    def explicit_refine_models(self):
        ...
        def explicit_refine(x):
            result = refinement.refine_explicitMD(x, openmm_platform='CUDA', niterations=5, nsteps_per_iteration=1)
            return result
