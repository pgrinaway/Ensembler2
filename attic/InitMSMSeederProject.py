...
argparser = argparse.ArgumentParser(description='Initialize Ensembler2 project by creating necessary subdirectories and a project metadata .yaml file.')
...
Ensembler2.attic.initproject.init(project_dir)
